...
namespace SandS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        //Nkosana NB : to prevent admin from being kick-out of page after new user has been created
        ...
        // private IdentityUser CreateUser() Commented out as we've changed Users to use Application Users Class
